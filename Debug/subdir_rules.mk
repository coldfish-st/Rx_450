...
build-777201025:
	@$(MAKE) --no-print-directory -Onone -f subdir_rules.mk build-777201025-inproc

build-777201025-inproc: ../uartecho.cfg
	@echo 'Building file: "$<"'
...
configPkg/linker.cmd: build-777201025 ../uartecho.cfg
configPkg/compiler.opt: build-777201025
configPkg/: build-777201025
